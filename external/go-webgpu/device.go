...
func (p *Device) Release() { C.aqua_wgpuDeviceRelease(global_ctx.ctx, p.ref) }
...
func (p *Device) CreateBindGroup(descriptor *BindGroupDescriptor) (*BindGroup, error) {
	...
	if err != nil {
		C.aqua_wgpuBindGroupRelease(global_ctx.ctx, ref)
		return nil, err
	}
...
func (p *Device) CreateBindGroupLayout(descriptor *BindGroupLayoutDescriptor) (*BindGroupLayout, error) {
	...
	if err != nil {
		C.aqua_wgpuBindGroupLayoutRelease(global_ctx.ctx, ref)
		return nil, err
	}
...
func (p *Device) CreateBuffer(descriptor *BufferDescriptor) (*Buffer, error) {
	...
	if err != nil {
		C.aqua_wgpuBufferRelease(global_ctx.ctx, ref)
		return nil, err
	}

	C.aqua_wgpuDeviceAddRef(global_ctx.ctx, p.ref)
...
func (p *Device) CreateCommandEncoder(descriptor *CommandEncoderDescriptor) (*CommandEncoder, error) {
	...
	if err != nil {
		C.aqua_wgpuCommandEncoderRelease(global_ctx.ctx, ref)
		return nil, err
	}
...
func (p *Device) CreateComputePipeline(descriptor *ComputePipelineDescriptor) (*ComputePipeline, error) {
	...
	if err != nil {
		C.aqua_wgpuComputePipelineRelease(global_ctx.ctx, ref)
		return nil, err
	}
...
func (p *Device) CreatePipelineLayout(descriptor *PipelineLayoutDescriptor) (*PipelineLayout, error) {
	...
	if err != nil {
		C.aqua_wgpuPipelineLayoutRelease(global_ctx.ctx, ref)
		return nil, err
	}
...
func (p *Device) CreateQuerySet(descriptor *QuerySetDescriptor) (*QuerySet, error) {
	...
	if err != nil {
		C.aqua_wgpuQuerySetRelease(global_ctx.ctx, ref)
		return nil, err
	}
...
func (p *Device) CreateRenderBundleEncoder(descriptor *RenderBundleEncoderDescriptor) (*RenderBundleEncoder, error) {
	...
	ref := C.aqua_wgpuDeviceCreateRenderBundleEncoder(global_ctx.ctx, p.ref, &desc)
...
func (p *Device) CreateRenderPipeline(descriptor *RenderPipelineDescriptor) (*RenderPipeline, error) {
	...
	if err != nil {
		C.aqua_wgpuRenderPipelineRelease(global_ctx.ctx, ref)
		return nil, err
	}
...
func (p *Device) CreateSampler(descriptor *SamplerDescriptor) (*Sampler, error) {
	...
	if err != nil {
		C.aqua_wgpuSamplerRelease(global_ctx.ctx, ref)
		return nil, err
	}
...
func (p *Device) CreateShaderModule(descriptor *ShaderModuleDescriptor) (*ShaderModule, error) {
	...
	if err != nil {
		C.aqua_wgpuShaderModuleRelease(global_ctx.ctx, ref)
		return nil, err
	}
...
func (p *Device) CreateTexture(descriptor *TextureDescriptor) (*Texture, error) {
	...
	if err != nil {
		C.aqua_wgpuTextureRelease(global_ctx.ctx, ref)
		return nil, err
	}
...
func (p *Device) GetFeatures() []FeatureName {
	...
	C.aqua_wgpuDeviceGetFeatures(global_ctx.ctx, p.ref, (*C.WGPUSupportedFeatures)(unsafe.Pointer(&supportedFeatures)))
...
func (p *Device) GetLimits() Limits {
	...
	C.aqua_wgpuDeviceGetLimits(global_ctx.ctx, p.ref, &limits)
...
func (p *Device) GetQueue() *Queue {
	ref := C.aqua_wgpuDeviceGetQueue(global_ctx.ctx, p.ref)
	C.aqua_wgpuDeviceAddRef(global_ctx.ctx, p.ref)
	return &Queue{deviceRef: p.ref, ref: ref}
}

func (p *Device) HasFeature(feature FeatureName) bool {
	hasFeature := C.aqua_wgpuDeviceHasFeature(global_ctx.ctx, p.ref, C.WGPUFeatureName(feature))
	return goBool(hasFeature)
}

func (p *Device) Poll(wait bool, submissionIndex uint64) (queueEmpty bool) {
	return goBool(C.aqua_wgpuDevicePoll(global_ctx.ctx, p.ref, cBool(wait), (*C.WGPUSubmissionIndex)(unsafe.Pointer(&submissionIndex))))
}
